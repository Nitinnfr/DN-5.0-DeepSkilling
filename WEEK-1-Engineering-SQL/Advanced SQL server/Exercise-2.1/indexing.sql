-- ====================================================================
-- FULL DATABASE INDEXING LAB (SQLite Compatible)
-- Includes structures, seeds, and performance indexing structures
-- ====================================================================
...
-- --------------------------------------------------------------------
-- STEP 3: SEED SAMPLE DATA DATASET
-- --------------------------------------------------------------------
...
-- Goal: Fast lookups based on string text matches
-- ====================================================================

-- Step 1: Query to fetch product details before index creation (Table Scan)
SELECT * FROM Products WHERE ProductName = 'Laptop';

-- Step 2: Create a non-clustered index on ProductName
CREATE INDEX idx_products_productname ON Products(ProductName);

-- Step 3: Query to fetch product details after index creation (Index Seek)
SELECT * FROM Products WHERE ProductName = 'Laptop';


-- ====================================================================
-- Exercise 2: Creating a Clustered Index (Optimized for SQLite)
-- Goal: Accelerate filtering across range timelines or specific dates
-- ====================================================================

-- Step 1: Query to fetch orders before index creation
SELECT * FROM Orders WHERE OrderDate = '2023-01-15';

-- Step 2: Create an optimization index on OrderDate 
...
-- Goal: Optimize compound multi-column filtering conditions
-- ====================================================================
