using System;
using System.Data;
using Microsoft.Data.SqlClient; // Note: Modern .NET uses Microsoft.Data.SqlClient over System.Data.SqlClient
...
namespace PlayersManagerLib
{
    public class PlayerMapper : IPlayerMapper
    {
        private readonly string _connectionString = 
            "Data Source=(local);Initial Catalog=GameDB;Integrated Security=True;TrustServerCertificate=True;";
